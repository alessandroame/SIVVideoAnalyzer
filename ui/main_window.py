...
class MainWindow(QMainWindow):
    ...
    def _on_session_started(self, source_dir: str, output_dir: str, pilot_names: list, pilot_gliders: dict, model_name: str):
        ...
        title = f"<b>Sessione:</b> {os.path.basename(source_dir)} ({len(self.video_files)} video)"
        ...
        for vf in self.video_files:
            ...
            if sc.pilot_name:
                ...
                self.page_table.add_flight_row(vf, sc.pilot_name, sc.flight_number or 1, glider_col, phrase, is_confirmed=True, confidence=calc_conf, recorded_at=rec_dt)
            else:
                self.page_table.add_flight_row(vf, "In attesa...", 1, "", "In coda di analisi...", is_confirmed=False, recorded_at=rec_dt)
